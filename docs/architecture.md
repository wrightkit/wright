...
- [`ownership.md`](architecture/ownership.md): repository/product ownership, dependency direction, and capability boundaries;
- [`integration.md`](architecture/integration.md): source/provider integration, contract preservation, and failure routing;
- [`tooling.md`](architecture/tooling.md): Wright-owned lint, analyze, inspect, edit, agent, CI, and LSP tooling model.
