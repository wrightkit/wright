...
- **Expose a detailed public confidence taxonomy:** rejected because consumers primarily need a clear fact-versus-guidance distinction and provenance. Runtime/community/heuristic detail can remain source metadata where useful without becoming the main product model.
